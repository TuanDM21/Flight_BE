...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "API response wrapper for team list operations")
public class TeamListApiResponse {
	...
	public static TeamListApiResponse success(List<TeamDTO> data) {
		return TeamListApiResponse.builder()
				.message("Thành công")
				.statusCode(200)
				.data(data)
				.success(true)
	...
	public static TeamListApiResponse error(String message, int statusCode) {
		return TeamListApiResponse.builder()
				.message(message)
