...
public interface UserFlightShiftRepository extends JpaRepository<UserFlightShift, Long> {
 ...
 // Trong interface UserFlightShiftRepository
    ...
    @Query("SELECT new com.project.quanlycanghangkhong.dto.UserFlightShiftResponseSearchDTO(" +
    	       ...
    	       "ufs.flight.departureTime, " +    // sử dụng departureTime thay vì startTime
    	       "ufs.flight.arrivalTime " +         // sử dụng arrivalTime thay vì endTime
    	       // Nếu không cần location và description, bạn có thể comment chúng lại:
    	       // ", ufs.flight.location, " +
    	       // "ufs.flight.description" +
    	       ") " +
